...
/**
 * Returns a new game, initializing the boards and changing the game to the placing ships phase
 * @param player2ID the id of the second player that joined the game
 * @return [Game]
 */
