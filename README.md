...
The back-end is developed using the Spring framework and Kotlin, while the front-end is developed using React and TypeScript.

## Introduction


To build the backend we used the following technologies:
- **database**: PostgreSQL 
